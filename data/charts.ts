...
export const charts: Chart2x2[] = [
  ...
  },
  {
    ...
    readingNote:
      "The upper-right quadrant (high innovation + high worker priority) is Kelly's distinctive territory -- he explicitly frames AI as an economic opportunity that requires redistribution mechanisms, not restriction. OpenAI's Industrial Policy document moves into this quadrant as well, pairing enthusiasm for superintelligence with a Public Wealth Fund, 32-hour workweek pilots, and portable benefits -- though critics note that its worker provisions are aspirational rather than legislative. The lower-right (low innovation priority + high worker priority) is Sanders, Khanna, and CHT, where innovation concerns are subordinated to worker and equity concerns -- CHT explicitly argues that AI should not automate away meaningful work and proposes flipping the tax code to reward labor retention over capital expenditure. The upper-left (high innovation + low distributional focus) is the White House and OpenAI/Lehane, where competitiveness is the dominant frame. The lower-left captures proposals focused on compliance and risk mitigation without strong positions on either innovation acceleration or worker redistribution.",
  },
  {
